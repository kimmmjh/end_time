...
# cost 2955 versus 3030 in run_1.sh, and the two lists cover the grid exactly.
EXPERIMENT_L=(5 7 7 7 7 9 9)
EXPERIMENT_P=(0.010 0.008 0.009 0.011 0.012 0.009 0.011)
EXPERIMENT_SEED=(700510 700708 700709 700711 700712 700909 700911)
TOTAL=${#EXPERIMENT_L[@]}
