...
ROOT="$HOME/end_time"
GPU_ID=0  # Change this number to the physical GPU you want this script to use.

# Pure-ConvGRU checkpoints. L13/p=.02 has 600 completed epochs; L15/p=.015
# has 300. The complementary branches live in run_1.sh, and together the two
...
EXPERIMENT_L=(15 13 15)
EXPERIMENT_P=(0.015 0.020 0.015)
EXPERIMENT_LR=(0.0001 0.0003 0.001)
EXPERIMENT_SEED=(150015 130020 150015)
EXPERIMENT_CHECKPOINT=("$L15_CHECKPOINT" "$L13_CHECKPOINT" "$L15_CHECKPOINT")
TOTAL=${#EXPERIMENT_LR[@]}
