...
ROOT="$HOME/end_time"
GPU_ID=1  # Physical GPU used by this script.
...
# Fresh pure-ConvGRU runs complementary to run_0.sh.
EXPERIMENT_L=(13 15 13 15)
EXPERIMENT_P=(0.017 0.012 0.019 0.014)
EXPERIMENT_SEED=(130017 150012 130019 150014)
TOTAL=${#EXPERIMENT_L[@]}
