...
class TransformedEND3D(nn.Module):
    """Base model directly operating on 3D Space-Time sequences with 3D CNN/Attention."""
    ...
    def __init__(
        ...
        :param num_classes: The number of classes to classify (16 for 2D Toric Code).
        ...
        :param in_channels: The channels in the input (2 for X and Z bases).
        """
        super(TransformedEND3D, self).__init__()
