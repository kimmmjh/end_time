...
experiments=(
    "--architecture=convgru_mwpm --gru_channels=96 --gru_layers=2 --gru_kernel_size=3 --noise_model=circuit --rounds=$L --measurement_error_rate=0.008 --p=0.008 --loss_fn=dynamic --epochs=300 --batch_size=64 --batches=1024 --eval_batches=512 --final_eval_batches=2048 --L=$L --channels 96 96 96 --depths 4 4 4 --lr=0.0003 --amp_dtype=none --seed=5108 --save_model"
    "--architecture=convgru_mwpm --gru_channels=96 --gru_layers=2 --gru_kernel_size=3 --noise_model=circuit --rounds=$L --measurement_error_rate=0.009 --p=0.009 --loss_fn=dynamic --epochs=300 --batch_size=64 --batches=1024 --eval_batches=512 --final_eval_batches=2048 --L=$L --channels 96 96 96 --depths 4 4 4 --lr=0.0003 --amp_dtype=none --seed=5109 --save_model"
    "--architecture=convgru_mwpm --gru_channels=96 --gru_layers=2 --gru_kernel_size=3 --noise_model=circuit --rounds=$L --measurement_error_rate=0.010 --p=0.010 --loss_fn=dynamic --epochs=300 --batch_size=64 --batches=1024 --eval_batches=512 --final_eval_batches=2048 --L=$L --channels 96 96 96 --depths 4 4 4 --lr=0.0003 --amp_dtype=none --seed=5110 --save_model"
    "--architecture=convgru_mwpm --gru_channels=96 --gru_layers=2 --gru_kernel_size=3 --noise_model=circuit --rounds=$L --measurement_error_rate=0.011 --p=0.011 --loss_fn=dynamic --epochs=300 --batch_size=64 --batches=1024 --eval_batches=512 --final_eval_batches=2048 --L=$L --channels 96 96 96 --depths 4 4 4 --lr=0.0003 --amp_dtype=none --seed=5111 --save_model"
    "--architecture=convgru_mwpm --gru_channels=96 --gru_layers=2 --gru_kernel_size=3 --noise_model=circuit --rounds=$L --measurement_error_rate=0.012 --p=0.012 --loss_fn=dynamic --epochs=300 --batch_size=64 --batches=1024 --eval_batches=512 --final_eval_batches=2048 --L=$L --channels 96 96 96 --depths 4 4 4 --lr=0.0003 --amp_dtype=none --seed=5112 --save_model"
)
